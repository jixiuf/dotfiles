...
-- hs.hotkey.bind(hyper2, "f", function() toggleApp("com.apple.Safari") end )
hs.hotkey.bind(hyper2, "f", function() toggleApp("org.mozilla.firefox") end )
...
hs.hotkey.bind(hyper, "3", function() toggleApp("cn.apifox.app-pdv") end)
